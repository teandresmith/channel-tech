...
var PrefectureList = []string{
	...
	"Kagoshima", "Kanagawa", "Kochi", "Kumamoto", "Kyoto", "Mie", "Miyagi", "Miyazaki", "Nagano", "Nagasaki",
	"Nara", "Niigata", "Oita", "Okayama", "Osaka", "Okinawa", "Saga", "Saitama", "Shiga", "Shimane", "Shizuoka",
